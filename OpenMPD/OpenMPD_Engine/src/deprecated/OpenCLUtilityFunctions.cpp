#include <./GSPAT_RenderingEngine/src/OpenCLUtilityFunctions.h>
#include <stdlib.h>
#include <stdio.h>

bool OpenCLUtilityFunctions::createProgramFromFile(const char* programFile, cl_context context, cl_device_id device, cl_program* out_program){
