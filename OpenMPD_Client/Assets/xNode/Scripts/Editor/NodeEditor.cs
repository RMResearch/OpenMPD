        ...
        public virtual void OnBodyGUI() {
            ...
            while (iterator.NextVisible(enterChildren)) {
...

                {
                    ...
                    label.tooltip = iterator.displayName;
                    ...
                    //Debug.Log(iterator.displayName + " nodewidth: " + nodeWidth + " minmax = " + labelMin + " " + labelMax + " " + EditorGUIUtility.fieldWidth + ":" + EditorGUIUtility.fieldWidth);
                }
